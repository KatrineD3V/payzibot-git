const Discord = require('discord.js'),
      ...
      dbl = new DBL('ключ', { statsInterval: 3600000 }, client),
...
client.on("ready", () => {
  //client.setMaxListeners(111) <- работает нормально без этого
  console.log(client.user.tag) 
  dbl.postStats(client.guilds.cache.size);//я так и не понял, бот сделан на discord.js v11 или на v12
